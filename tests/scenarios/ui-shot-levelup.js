...
T.start('normal'); T.sim(25); G.build.picks = 1; step(1); step(1); return Object.assign(audit(), { level: G.build.level, cardPanel: !document.getElementById('cardPanel').hidden });
