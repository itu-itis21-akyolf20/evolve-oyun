const DIFF='dehset', PICK='random'; const PRE=()=>{ const D=EV.CFG.DIFFICULTY.dehset; D.deathEvoLoss=0.3; D.deathCardLoss=false; D.speed=1.0; D.hp=1.4; D.dmg=1.3; const M=EV.MOBS.ENEMIES; const sp={whip:7.6,fox:10.0,serpent:8.8,saber:9.6}; M.forEach(p=>p.forEach(d=>{ if(sp[d.id]) d.speed=sp[d.id]; })); };
